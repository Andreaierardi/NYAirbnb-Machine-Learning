...
\subsubsection{Random Forest}
Starting Random Forest regression for the price, givin the default parameters there were no problems. While, for the tuning of the parameters there were no possibilities, due to the large number of data points.
