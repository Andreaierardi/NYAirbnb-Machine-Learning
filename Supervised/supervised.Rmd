...
cat("Neighboorhood group = Manhattan and room_type = Entire home/apt\n ")
train_filtered = train %>% filter(neighbourhood_group == 1 & room_type == 1)
...
cat("Neighboorhood group = Manhattan\n ")
train_filtered = train %>% filter(neighbourhood_group ==1)
...
task2 = makeRegrTask(data = train_filtered[-1], target = "price")
...
res2 = tuneRanger(task, measure = list(mse), num.trees = 1000, 
                 num.threads = 8, iters = 20,  show.info = getOption("mlrMBO.show.info", TRUE))
...
cat("Neighboorhood group = Manhattan and room_type=Entire-home/Apt\n ")
train_filtered = train %>% filter(neighbourhood_group ==1 & room_type ==1)
train_filtered = train_filtered[-1][-3]
task2 = makeRegrTask(data = train_filtered, target = "price")
estimateTimeTuneRanger(task2, iters = 20, num.threads = 8, num.trees = 1000)
