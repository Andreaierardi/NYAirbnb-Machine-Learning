...
clean_data = function(ds, pr, region, room = NULL)
{
  ds =ds[c(5,7:10)]
  ...
  numerical = c("price","latitude","longitude")
...
dataset = clean_data(ds,500,NULL,"Entire home/apt")
...
geom_point(data = clust1, aes(y = latitude, x = longitude), color = "red") +
  geom_point(data = clust2, aes(y = latitude, x = longitude), color= "blue") +
    geom_point(data = clust3, aes(y = latitude, x = longitude), color= "green") +
  geom_point(data = clust4, aes(y = latitude, x = longitude), color= "yellow") +
...
mappa = ggplot(data = dataset,  aes(y=latitude,x = longitude))+geom_point()
